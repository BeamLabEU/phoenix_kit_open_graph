defmodule PhoenixKitOG.Test.Layouts do
  @moduledoc """
  ...
  # Phoenix's error pipeline tries to render "<status>.html" from the layouts
  # module if a LiveView raises during mount. Forward everything to a single
  # generic template so tests get a readable error instead of a
