defmodule PhoenixKitOG.MigrationsRuntimeTest do
  ...
  @anchor "phoenix_kit_og_templates"
  ...
  test "reads the version parsed out of the pkog_schema marker" do
    Repo.query!("COMMENT ON TABLE #{@anchor} IS 'pkog_schema:1'")
