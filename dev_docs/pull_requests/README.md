...
This directory contains documentation for significant pull requests merged into PhoenixKitOG. It serves as an archive of design decisions, review feedback, and implementation context that lives within the repository.
...
├── 2026/                     # Year
│   ├── 1-initial-og-module/  # PR #1 - slug for readability
...
- **Examples**: `1-initial-og-module`, `2-add-stamp-elements`
